...
export declare const getSchemaUUID: (schema: string, resolverAddress: string, revocable: boolean) => string;
...
export declare const getUUIDFromMultiAttestTx: (res: Promise<ContractTransaction> | ContractTransaction) => Promise<any[]>;
